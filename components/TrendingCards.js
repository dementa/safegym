...
const gymClasses = [
    ...
    const trendingClasses = gymClasses.filter((item) => 
      item.categories.some((category) => category === "trending")
    );
...
const TrendingCard = () => {
  ...
  return (
    <View>
        <View>
            <Text style={{ marginBottom: 16, marginLeft: 16, fontSize: 24}}>Trending Slots</Text>
